  ...
  return (
    <div className="flex justify-center">
      <svg width="280" height="260" viewBox="0 0 280 260">
        {/* TAM */}
        <circle cx={cx} cy={cy} r={tamR} fill="rgba(99,102,241,0.08)" stroke="var(--chroma-indigo)" strokeOpacity="0.3" strokeWidth="1.5" />
        ...
        {/* SAM */}
        <circle cx={cx} cy={cy + (tamR - samR) * 0.3} r={samR} fill="rgba(6,182,212,0.1)" stroke="var(--chroma-cyan)" strokeOpacity="0.4" strokeWidth="1.5" />
        ...
        {/* SOM */}
        <circle cx={cx} cy={cy + (tamR - somR) * 0.5} r={somR} fill="rgba(34,197,94,0.12)" stroke="var(--state-healthy)" strokeOpacity="0.5" strokeWidth="1.5" />
