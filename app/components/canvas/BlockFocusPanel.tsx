  ...
  return (
    <>
      ...
      >
        ...
        {/* Fixed divider with collapse toggle */}
        <div className="shrink-0 relative flex items-center px-4 py-1.5 border-t border-white/5 bg-background/95 backdrop-blur-sm">
        ...
        {chatSection && (
          <div className="shrink-0 h-[45vh] flex flex-col border-t border-white/5 bg-background">{chatSection}</div>
        )}
      </div>
    </>
  );
