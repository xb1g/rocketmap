...
import type { BlockData, BlockItem, BlockType, CanvasMode, Segment } from '@/lib/types/canvas';
...
interface BMCGridProps {
  ...
  onItemUpdate?: (blockType: BlockType, itemId: string, updates: Partial<BlockItem>) => void;
...
export function BMCGrid({
  ...
  const segmentRefCallback = useCallback((segId: number, el: HTMLElement | null) => {
